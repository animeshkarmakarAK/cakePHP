...
class MoviesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'short_description' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'poster' => ['type' => 'string', 'length' => 60, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'release_year' => ['type' => 'datetime', 'length' => null, 'precision' => null, 'null' => false, 'default' => null, 'comment' => ''],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'release_year' => '2020-12-02 09:02:24',
                'rating' => 1,
            ],
        ];
        parent::init();
